...
*/
    get containers () {
        return this.matrix.map(arr => arr.reduce((acc, curr) => acc + curr));
    }

    get balls () {
        return this.matrix.reduce((acc, curr) => {
...
*/
    evaluate() {
        let c = this.containers.toFrequency();
        let bd = this.balls.toFrequency();
        whileLoop:
        while (!Object.compare(c, bd)) {
